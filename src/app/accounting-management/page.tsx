...
export default function AccountingPurchasesPage() {
  ...
  const processReceiptImage = async (imageBase64: string, fileBlob: Blob) => {
    ...
    try {
      ...
      if (!user) throw new Error('認証情報が取得できません。');
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4">
              ...
              >
                {isAnalyzing ? (
                  <div className="flex flex-col items-center justify-center space-y-2 z-10">
                    ...
                    <span className="font-bold text-xs text-emerald-700">AIがレシートを解析中...</span>
                  </div>
                ) : (
                  <>
                    ...
                    <span className="text-[10px] text-emerald-600/70">スマホのカメラまたは画像ファイル</span>
                  </>
                )}
                <input 
                  type="file" 
              ...
              <div className="space-y-3 pt-1">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs outline-none focus:ring-2 focus:ring-emerald-500 font-medium"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs outline-none focus:ring-2 focus:ring-emerald-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs outline-none focus:ring-2 focus:ring-emerald-500 font-medium text-right"
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-6 pr-3 py-2 text-xs outline-none focus:ring-2 focus:ring-emerald-500 font-medium text-right"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white border-2 border-emerald-500 rounded-xl pl-6 pr-3 py-2 outline-none focus:ring-2 focus:ring-emerald-500/20 font-black text-emerald-700 text-sm text-right"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs outline-none focus:ring-2 focus:ring-emerald-500 resize-none"
                  ></textarea>
                </div>
              </div>
              ...
              <button
                ...
                className={`w-full py-2.5 rounded-xl font-bold text-xs text-white shadow-sm transition-all flex items-center justify-center gap-2 ${
                  submitSuccess ? 'bg-emerald-600' : 'bg-emerald-600 hover:bg-emerald-700'
                }`}
              >
                {submitSuccess ? (
