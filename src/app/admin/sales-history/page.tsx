          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 text-sm">
                ...
                <th className="p-4 font-bold text-right">売上金額・単価</th>
                      ...
                      <td className="p-4 text-right">
                        {hasPrice ? (
                          <div>
                            ...
                            <div className="text-xs text-emerald-600 font-bold flex items-center justify-end gap-1 mt-0.5">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 rounded-xl font-bold text-xs transition-colors cursor-pointer"
            ...
            <form onSubmit={handleSavePrice} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-8 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-amber-500 font-bold text-slate-800 text-lg"
                    placeholder="例: 250"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-8 pr-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-amber-500 font-black text-amber-600 text-2xl"
                    placeholder="例: 12500"
                    required
                  />
                </div>
              ...
              <div className="pt-3 flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-amber-600 hover:bg-amber-700 disabled:bg-slate-300 text-white font-bold rounded-xl text-sm transition-colors shadow-md flex items-center justify-center gap-2 cursor-pointer"
                >
                  {isSavingPrice ? (
                    <span>保存中...</span>
                  ) : (
